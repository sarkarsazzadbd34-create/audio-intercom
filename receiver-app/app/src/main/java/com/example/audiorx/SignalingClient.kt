...
/**
 * Same protocol as the transmitter's SignalingClient. Connects either to
 * the transmitter's own embedded server (LAN mode, ws://<phone-ip>:<port>)
 * or to the Node.js relay (internet mode, wss://.../ws).
 */
